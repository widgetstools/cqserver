...
const badgeVariants = cva(
  'inline-flex items-center gap-1 rounded-sm px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-[0.06em] leading-none font-mono',
  {
    variants: {
      variant: {
        default: 'bg-secondary text-secondary-foreground',
        primary: 'bg-info-muted text-info border border-info/30',
        signal: 'bg-signal-muted text-signal border border-signal/40',
